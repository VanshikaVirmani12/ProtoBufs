...
json_t* weather_json_serialize(const WeatherDataJson* weatherDataJson) {
    ...
    json_object_set_new(obj, "day_of_week", json_string(weatherDataJson->day_of_week));
    ...
    json_object_set_new(obj, "temperature", json_real(weatherDataJson->temperature));
    ...
    json_object_set_new(obj, "wind_speed", json_real(weatherDataJson->wind_speed));
    json_object_set_new(obj, "wind_direction", json_real(weatherDataJson->wind_direction));
    json_object_set_new(obj, "rain_last_hour", json_real(weatherDataJson->rain_last_hour));
    json_object_set_new(obj, "solar_radiation", json_real(weatherDataJson->solar_radiation));
    ...
    json_object_set_new(obj, "wind_chill", json_real(weatherDataJson->wind_chill));
    json_object_set_new(obj, "snow_depth", json_integer(weatherDataJson->snow_depth));
    return obj;
}
